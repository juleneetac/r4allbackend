...
exports.addParticipante = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var participante, newParticipante, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    participante = req.body.participante;
                    newParticipante = new ParticipantesSchema(participante);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, newParticipante.save()];
                case 2:
                    _a.sent();
