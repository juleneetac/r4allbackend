...
exports.addTorneo = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var torneo, newTorneo, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    torneo = req.body.torneo;
                    newTorneo = new TorneosSchema(torneo);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, newTorneo.save()];
                case 2:
                    _a.sent();
...
exports.getTorneo = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var my_id, torneo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    my_id = req.params.torneoId;
...
exports.getTorneos = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var torneo;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, TorneosSchema.find()];
                case 1:
                    torneo = _a.sent();
                    console.log(torneo);
                    if (torneo) {
...
exports.getParticipantesde = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var my_id, partic;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    my_id = req.params.torneoId;
                    return [4 /*yield*/, TorneosSchema.findById(my_id).populate('participantes')];
                case 1:
                    partic = _a.sent();
